...
class CompetencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competence" do
    assert_difference('Competence.count') do
      post competences_url, params: { competence: { content: @competence.content, title: @competence.title } }
    end
  ...
  test "should update competence" do
    patch competence_url(@competence), params: { competence: { content: @competence.content, title: @competence.title } }
